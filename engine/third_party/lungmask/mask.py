'''
Approach by: 
	Hofmanninger, J., Prayer, F., Pan, J. et al. 
	Automated lung segmentation in CT under presence of severe pathologies
	Eur Radiol Exp 4, 50 (2020). https://doi.org/10.1186/s41747-020-00173-2
'''
...
def get_model(modeltype, modelname):
    ...
    print("modeltype: {} || modelname {}".format(modeltype, modelname))
    if modeltype == 'unet':
