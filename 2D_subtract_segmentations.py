...
def main():
    ...
    parser.add_argument('-le', '--lesion_folder', default='//data/01_UB/00_Dev/01_SNF_Dataset_First_Paper/06_2nd-testset_Raw-Lesion_seg/')
    parser.add_argument('-lu', '--lung_folder', default='//data/01_UB/00_Dev/01_SNF_Dataset_First_Paper/06_2nd-testset_LungSeg/')
    parser.add_argument('-o', '--output_folder', default='//data/01_UB/00_Dev/01_SNF_Dataset_First_Paper/06_2nd-testset_LesionSeg/')
